...
export function buildSampleStore() {
  ...
  return {
    meta: {
      ...
      mode: "mixed_public",
      message:
        "公开数据已覆盖至：SSD 与 DRAM/HBM 月度 HS 2026年5月、半导体月度 2026年5月、旬度高频 2026年6月1-20日；2026-06-25 复核，DATA_GO_KR_SERVICE_KEY 未配置，月度 HS 使用 KITA K-stat 官方公开 worker 当年金额与 KG；KCS 官方页面、HWPX 附件和 KDI/Korea Tax Times 转发核验 6 月旬度总量。6月1-20日半导体金额为 KCS 正文披露的约 255 亿美元官方四舍五入值；KCS 6月23-24日较新稿件不属于 수출입 현황 数据发布，6月25日未发现更新的 수출입 현황；未发现可公开落库的 2026.06 月度 HS 当前年行。"
    },
    ...
    freshness: [
      ...
      },
      {
        ...
        note:
          "2026-06-25 复核：KCS 官网发布 2026-06-22 的 6月1-20日暂定值，KDI 转发同一简报，TRASS 首页交叉核验总出口/进口；KCS 6月23-24日较新列表项为 CBAM、半导体部件分类等非 수출입 현황 发布，6月25日未发现更新的 수출입 현황。KCS 正文和 HWPX 文本核验总出口 61,991M 美元、进口 44,495M 美元、贸易顺差 17,496M 美元、半导体同比 +188.4%、半导体占比 41.2%，并披露半导体出口约 255 亿美元；HWPX 中的主要品目图表为图片，未提取到可公开落库的更精确半导体金额。"
      },
      {
        key: "memory_provisional_detail",
        label: "存储细分明细",
        latestPeriod: "2026年5月全月官方细分；2026年5月1-20日价格/数量暂估",
        latestReleaseDate: "2026-06-25 复核",
        nextExpectedDate: "等待 TRASS/KITA 或市场转述公开 2026年6月旬度 DRAM/SSD/HBM 细分数据；6月月度 HS 明细预计 2026年7月中旬",
        status: "mixed_public_reported",
        note:
          "2026-06-25 复核：MOTIE 5月 수출입 동향公开转发文本核验 Memory、DRAM、NAND、Computer/SSD proxy 金额和 YoY；HS 月度图已用 KITA K-stat 补入 2026.05 SSD 与 DRAM/HBM proxy 金额、KG、单价。KCS 6月1-20日简报只公开半导体合计、YoY 和占比，仍未发现可核验的 6月1-10日或 6月1-20日 DRAM/SSD/HBM 旬度细分公开表；5月前20日价格/数量仍来自公开券商/市场 Telegram 镜像转述的 Korean customs/TRASS 暂估。"
      }
    ],
    sourceRegistry: [
      {
      ...
      },
      {
        ...
        status: "official_public_rounded_verified_2026_06_25",
      ...
      {
        key: "kcs_official_press_list_20260625",
        section: "ten_day_semiconductor",
        ...
        status: "official_public_checked_2026_06_25",
        note: "KCS official press-release list/search was checked on 2026-06-25. Newer KCS list items dated 2026-06-23 and 2026-06-24 were not export-status releases, and no 2026-06-25 export-status release was found. The newest export-tracking release found is 2026년 6월 1일 ~ 6월 20일 수출입 현황 [잠정치], registered 2026-06-22 with nttSn 10167371."
      },
      {
      ...
      {
        key: "kita_kstat_hs_worker_20260625",
        section: "monthly_hs_context",
        sourceName: "KITA K-stat ItemImpExpList worker",
        sourceUrl: "https://stat.kita.net/stat/kts/pum/ItemImpExpList.screen",
        status: "official_public_web_verified_2026_06_25",
