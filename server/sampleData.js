...
export function buildSampleStore() {
  ...
  return {
    meta: {
      ...
      mode: "mixed_public",
      message:
        "公开数据已覆盖至：SSD 与 DRAM/HBM 月度 HS 2026年5月、半导体月度 2026年5月、旬度高频 2026年6月1-20日；2026-06-28 复核，DATA_GO_KR_SERVICE_KEY 未配置，月度 HS 使用 KITA K-stat 官方公开 worker 当年金额与 KG；KCS 官方页面、HWPX 附件和 KDI/Korea Tax Times 转发核验 6 月旬度总量。6月1-20日半导体金额为 KCS 正文披露的约 255 亿美元官方四舍五入值；KCS 6月23-26日较新稿件不属于 수출입 현황 数据发布，截至 6月28日未发现更新的 수출입 현황；未发现可公开落库的 2026.06 月度 HS 当前年行。"
    },
    ...
    freshness: [
      {
        ...
        latestReleaseDate: "2026-06-28 复核：KITA K-stat worker 仍只返回 2026.05 当前年 HS 金额与 KG；TRASS 首页显示 2026-06-15 已完成 5 月确报构建",
        nextExpectedDate: "2026年6月 HS 明细预计 2026年7月中旬随 KCS/data.go.kr/TRASS/KITA 更新",
        status: "official_public_web",
        note:
          "2026-06-28 复核，KITA K-stat ItemImpExpList worker 对 SSD HS 852351 返回 2026.05 出口金额 3,973,455 thousand USD、重量 177,484 kg；对 DRAM/HBM proxy HS 854232 返回出口金额 24,950,563 thousand USD、重量 326,954 kg。强制查询 2026.06 对两个 HS code 均未返回可落库当前年 HS 行。KCS TradeData 英文页同源接口未作为本次落库来源；DATA_GO_KR_SERVICE_KEY 未配置，未调用 KCS/data.go.kr API。"
      },
      {
        key: "monthly_semiconductor",
        label: "半导体月度总量",
        latestPeriod: "2026年5月",
        latestReleaseDate: "2026-06-15 确报复核",
        nextExpectedDate: "2026年6月全月初值预计 2026-07-01 左右；6月确报预计 2026年7月中旬",
        status: "official_public_repost",
        note:
          "KCS/Korea.kr/KDI 2026-06-15 确报复核 5 月总出口约 878 亿美元、同比 +53.4%，半导体出口同比 +167.7%；TRASS 首页显示 5 月确报总出口 87,821M 美元。MOTIE 5 月 수출입 동향公开转发文本仍是当前可核验半导体全月金额来源：37,160M 美元、同比 +169.4%，该金额未用确报同比倒推。"
      },
      {
        ...
        nextExpectedDate: "2026-07-01 左右发布 2026年6月全月初值；2026-07-11 左右发布 2026年7月1-10日暂定值",
        status: "official_public_rounded",
        note:
          "2026-06-28 复核：KCS 官网发布 2026-06-22 的 6月1-20日暂定值，KDI 转发同一简报，TRASS 首页交叉核验总出口/进口；KCS 6月23-26日较新列表项为 CBAM、半导体部件分类、统计会议、세수 통계、AI 政府表彰 等非 수출입 현황 发布，截至 6月28日未发现更新的 수출입 현황。KCS 正文和 HWPX 文本核验总出口 61,991M 美元、进口 44,495M 美元、贸易顺差 17,496M 美元、半导体同比 +188.4%、半导体占比 41.2%，并披露半导体出口约 255 亿美元；HWPX 中的主要品目图表为图片，未提取到可公开落库的更精确半导体金额。"
      },
      {
        key: "memory_provisional_detail",
        label: "存储细分明细",
        latestPeriod: "2026年5月全月官方细分；2026年5月1-20日价格/数量暂估",
        latestReleaseDate: "2026-06-28 复核",
        nextExpectedDate: "等待 TRASS/KITA 或市场转述公开 2026年6月旬度 DRAM/SSD/HBM 细分数据；6月月度 HS 明细预计 2026年7月中旬",
        status: "mixed_public_reported",
        note:
          "2026-06-28 复核：MOTIE 5月 수출입 동향公开转发文本核验 Memory、DRAM、NAND、Computer/SSD proxy 金额和 YoY；HS 月度图已用 KITA K-stat 补入 2026.05 SSD 与 DRAM/HBM proxy 金额、KG、单价。KCS 6月1-20日简报只公开半导体合计、YoY 和占比，仍未发现可核验的 6月1-10日或 6月1-20日 DRAM/SSD/HBM 旬度细分公开表；5月前20日价格/数量仍来自公开券商/市场 Telegram 镜像转述的 Korean customs/TRASS 暂估。"
      }
    ],
    sourceRegistry: [
      {
      ...
      },
      {
        ...
        status: "official_public_rounded_verified_2026_06_28",
      ...
      {
        key: "kcs_official_press_list_20260628",
        section: "ten_day_semiconductor",
        ...
        status: "official_public_checked_2026_06_28",
        note: "KCS official press-release list/search was checked on 2026-06-28. Newer KCS list items dated 2026-06-23 through 2026-06-26 were not export-status releases, and no newer export-status release was found as of 2026-06-28. The newest export-tracking release found is 2026년 6월 1일 ~ 6월 20일 수출입 현황 [잠정치], registered 2026-06-22 with nttSn 10167371."
      },
      {
