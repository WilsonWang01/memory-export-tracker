...
export function buildSampleStore() {
  ...
  return {
    meta: {
      ...
      mode: "mixed_public",
      message:
        "公开数据已覆盖至：SSD 与 DRAM/HBM 月度 HS 2026年5月、半导体月度 2026年6月、KCS 海关高频/暂定值 2026年6月1-30日；2026-07-10 复核，DATA_GO_KR_SERVICE_KEY 未配置，月度 HS 使用 KITA K-stat 官方公开 worker 当年金额与 KG。KCS 官网 보도자료 列表和 KDI 转发已出现 6月全月 수출입 현황 [잠정치]，验证总出口/进口/顺差及半导体首次超过 400 亿美元；TRASS 公开首页同步显示 6月1-30日暂定总出口/进口和 5月确报总量；Korea.kr/MOTIE 提供 6月全月半导体 448.2 亿美元、同比 +199.5%，电脑/SSD proxy 54.1 亿美元、同比 +308.8%。未发现可公开落库的 2026.06 月度 HS 当前年行，也未发现 2026年7月1-10日暂定值。"
    },
    ...
    freshness: [
      ...
      },
      {
        ...
        status: "official_public_repost",
        note:
          "2026-07-10 复核：KCS 官网 보도자료 列表最新页已有 2026-07-09 非出口状态新闻，但未出现 2026年7月1日~7月10日 수출입 현황 [잠정치]；2026-07-02 发布的 2026年6月 수출입 현황 [잠정치] 仍为最新出口状态简报。KDI 转发同一 KCS 6月1-30日简报并验证总出口 1,023 亿美元、进口 661 亿美元、贸易顺差 361 亿美元。KCS/Korea.kr/KDI 搜索未发现 2026年7月1日~7月10日 수출입 현황 [잠정치]，该窗口仍预计 2026-07-11 左右发布。KCS/KDI HTML 摘要只披露半导体首次超过 400 亿美元，未给出可落库的精确半导体金额；精确 6月半导体金额仍使用 Korea.kr/MOTIE 的 448.2 亿美元。"
      },
      {
        key: "memory_provisional_detail",
        label: "存储细分明细",
        latestPeriod: "2026年6月全月电脑/SSD proxy；2026年5月全月官方存储细分；2026年5月1-20日价格/数量暂估",
        latestReleaseDate: "2026-07-10 复核",
        nextExpectedDate: "等待 TRASS/KITA 或市场转述公开 2026年6月 DRAM/SSD/HBM 细分数据；6月月度 HS 明细预计 2026年7月中旬",
        status: "mixed_public_reported",
        note:
          "2026-07-10 复核：Korea.kr/MOTIE 6月 수출입 동향核验半导体总量和电脑/SSD proxy 金额及 YoY，KCS/KDI 全月海关简报验证半导体首次超过 400 亿美元，但二者未公开 DRAM/NAND/HBM 数量或重量；MOTIE 5月 수출입 동향公开转发文本仍是最新可核验 Memory、DRAM、NAND 细分金额来源。HS 月度图已用 KITA K-stat 补入 2026.05 SSD 与 DRAM/HBM proxy 金额、KG、单价；2026.06 HS 行尚不可落库。"
      }
    ],
    sourceRegistry: [
      {
      ...
      {
        key: "kcs_official_press_list_20260710",
        section: "ten_day_semiconductor",
        ...
        status: "official_public_checked_2026_07_10",
        note: "KCS official press-release list was checked on 2026-07-10. Page 1 shows 2026-07-09 non-export-status releases and no 2026년 7월 1일 ~ 7월 10일 release. The newest export-status release visible in official/repost searches remains 2026년 6월 수출입 현황 [잠정치], registered 2026-07-02."
      },
      {
      ...
      },
      {
        ...
        status: "public_aggregate_only_checked_2026_07_10",
        note: "Public homepage check on 2026-07-10 shows 2026 May final data built on 2026-06-15 and public aggregate widgets only. TRASS public widgets show 2026 May final total exports of USD 87,821M (+53.37%) and imports of USD 60,785M (+20.74%), plus June 1-30 provisional exports of USD 102,251M (+70.89%) and imports of USD 66,101M (+30.05%). Public widgets do not expose export values for semiconductor/memory splits; product-level provisional lookup is outside the free public widget surface and was not used."
      },
      {
