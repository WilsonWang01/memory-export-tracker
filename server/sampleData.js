...
export function buildSampleStore() {
  ...
  return {
    meta: {
      ...
      mode: "mixed_public",
      message:
        "公开数据已覆盖至：SSD 与 DRAM/HBM 月度 HS 2026年4月、半导体月度 2026年4月、旬度 2026年5月1-20日；截至 2026-05-27 未配置 DATA_GO_KR_SERVICE_KEY，月度 HS 来自 KCS TradeData 官方网页核验，旬度半导体来自 KCS 官方简报附件。"
    },
    ...
    freshness: [
      ...
      },
      {
        ...
        latestReleaseDate: "2026-05-27（KCS 页面登记日；附件文件名为 260521）",
        nextExpectedDate: "2026-06-01 左右发布 2026年5月月度初值",
        status: "official_public",
        note:
          "KCS 官方页面登记日为 2026-05-27，正文显示 5月1~20日总出口 52,652M 美元、总进口 41,618M 美元，并概述半导体约 220 亿美元；官方 PDF 附件第 4 页给出半导体出口 21,951M 美元、同比 +202.1%。"
      },
      {
    ...
    sourceRegistry: [
      ...
      },
      {
        ...
        note: "Official API source for monthly HS export value and net weight. DATA_GO_KR_SERVICE_KEY was not present in the 2026-05-27 refresh environment; data.go.kr lists this API as modified 2026-05-22 and explains monthly data is refreshed around the 15th after corrections/cancellations. Use SSD HS 852351 and DRAM/HBM proxy HS 854232 when configured."
      },
      {
        ...
        status: "official_public_verified_2026_05_27",
        note: "KCS official page was registered 2026-05-27 and includes PDF/HWPX attachments named 260521. The page verifies the May 1-20 aggregate total; the official PDF attachment gives semiconductor exports of USD 21,951M and YoY +202.1%."
      },
      {
