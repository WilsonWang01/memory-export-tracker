...
export function buildSampleStore() {
  ...
  return {
    meta: {
      ...
      mode: "mixed_public",
      message:
        "公开数据已覆盖至：SSD 与 DRAM/HBM 月度 HS 2026年4月、半导体月度 2026年4月、旬度 2026年5月1-20日；截至 2026-05-24 未配置 DATA_GO_KR_SERVICE_KEY，月度 HS 来自 KCS TradeData 官方网页核验。"
    },
    ...
    freshness: [
      ...
      },
      {
        ...
        note:
          "KCS TradeData 官方首页已列示 2026-05-21 的 5 月前 20 日暂定值简报；TRASS 公开首页同步显示 5月1~20日总出口/进口暂定值。半导体精确金额 21,951M 美元和同比 +202.1% 来自多家媒体对该 KCS 简报的同日转述交叉核验，官方公开文本只显示约 220 亿美元。Korea.kr 与 KCS 主站新闻列表截至 2026-05-24 核验时仍未显示该原始简报。"
      },
      {
    ...
    sourceRegistry: [
      ...
      },
      {
        ...
        note: "Official API source for monthly HS export value and net weight. DATA_GO_KR_SERVICE_KEY was not present in the 2026-05-24 refresh environment; data.go.kr lists this API as modified 2026-05-22 and explains monthly data is refreshed around the 15th after corrections/cancellations. Use SSD HS 852351 and DRAM/HBM proxy HS 854232 when configured."
      },
      {
      ...
      },
      {
        ...
        status: "not_found_2026_05_24",
        note: "Korea.kr search did not expose a repost of the 2026-05-21 KCS May 1-20 provisional release during this refresh; the May 1-10 KCS repost is available and was used only for the May 1-10 point."
      },
      {
      ...
      },
      {
        ...
        status: "blocked_or_queue_2026_05_24",
        note: "KITA K-stat was checked but the live page returned an access-wait/block screen in this environment. Search snippets indicated 2026.04 trade pages exist, but no KITA numbers were added because the needed source page was not publicly accessible."
      }
    ],
    officialMonthly: [
      {
    ...
    preliminary: [
      ...
      },
      {
        ...
        status: "preliminary",
        sourceName: "KCS/TRASS May 1-20 provisional release, exact semiconductor value cross-checked via media quoting KCS",
        sourceUrl: "https://www.tradedata.go.kr/cts/index.do",
        ...
        officialListUrl: "https://www.customs.go.kr/kcs/na/ntt/selectNttList.do?bbsId=1362&mi=2891",
        note: "KCS TradeData homepage lists the 2026-05-21 provisional release and public copied text of that release gives rounded semiconductor exports of USD 22.0B with YoY +202.1%. TRASS public homepage confirms the overall May 1-20 provisional trade totals. Same-day media reports quoting KCS provide the exact semiconductor value of USD 21,951M. The publicly visible official/TRASS pages do not provide a DRAM/SSD/HBM split."
      }
    ]
  };
}
