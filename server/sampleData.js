...
export function buildSampleStore() {
  ...
  return {
    meta: {
      ...
      mode: "mixed_public",
      message:
        "公开数据已覆盖至：SSD 与 DRAM/HBM 月度 HS 2026年4月、半导体月度 2026年4月、旬度 2026年5月1-20日；截至 2026-05-25 未配置 DATA_GO_KR_SERVICE_KEY，月度 HS 来自 KCS TradeData 官方网页核验。"
    },
    ...
    freshness: [
      ...
      },
      {
        ...
        note:
          "KCS TradeData 官方首页已列示 2026-05-21 的 5 月前 20 日暂定值简报；TRASS 公开首页同步显示 5月1~20日总出口/进口暂定值。官方公开文本只显示约 220 亿美元和同比 +202.1%；半导体精确金额 21,951M 美元来自多家媒体对该 KCS 简报的同日转述交叉核验。Korea.kr 与 KCS 主站新闻列表截至 2026-05-25 核验时仍未显示该原始简报。"
      },
      {
    ...
    sourceRegistry: [
      ...
      },
      {
        ...
        note: "Official API source for monthly HS export value and net weight. DATA_GO_KR_SERVICE_KEY was not present in the 2026-05-25 refresh environment; data.go.kr lists this API as modified 2026-05-22 and explains monthly data is refreshed around the 15th after corrections/cancellations. Use SSD HS 852351 and DRAM/HBM proxy HS 854232 when configured."
      },
      {
      ...
      },
      {
        ...
        status: "public_context_verified_2026_05_25",
        note: "KITA K-stat public homepage was reachable and showed Korea updated through 2026.04, April 2026 trade-analysis links, and a public 854232 country table. No KITA figures were added to the dashboard because KCS/data.go.kr remains the primary source for monthly HS values and KITA did not expose a more recent May monthly HS point."
      }
    ],
    officialMonthly: [
      {
