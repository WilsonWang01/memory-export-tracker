...
`DATA_GO_KR_SERVICE_KEY` was not present in the 2026-06-26 refresh environment, so the official KCS itemtrade API path could not be used by `npm run fetch`.
...
Latest official high-frequency release as of 2026-06-26:
...
KCS list/search check on 2026-06-26:

- Official KCS search resolved to the 2026-06-22 `2026년 6월 1일 ~ 6월 20일 수출입 현황 [잠정치]` release with nttSn `10167371`.
- Newer KCS press-release list items dated 2026-06-23 through 2026-06-26 were CBAM, semiconductor-parts classification, trade-statistics coordination, customs-tax statistics, and other non-`수출입 현황` posts; they were not dashboard export-tracking releases.
- No 2026-06-26 KCS `수출입 현황` release was found during this refresh.
...
TRASS public homepage check on 2026-06-26:
...
KITA monthly HS worker check on 2026-06-26:
