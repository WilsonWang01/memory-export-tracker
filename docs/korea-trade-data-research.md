...
`DATA_GO_KR_SERVICE_KEY` was not present in the 2026-06-24 refresh environment, so the official KCS itemtrade API path could not be used by `npm run fetch`.
...
Latest official high-frequency release as of 2026-06-24:
...
KCS list/search check on 2026-06-24:

- Official KCS search resolved to the 2026-06-22 `2026년 6월 1일 ~ 6월 20일 수출입 현황 [잠정치]` release with nttSn `10167371`.
- Newer KCS press-release list items dated 2026-06-23 and 2026-06-24 were CBAM, semiconductor-parts classification, and other non-`수출입 현황` posts; they were not dashboard export-tracking releases.
...
TRASS public homepage check on 2026-06-24:

- The public homepage showed May final aggregate totals: exports USD 87,821M (+53.37%) and imports USD 60,785M (+20.74%).
- It also showed June 1-20 provisional aggregate totals: exports USD 61,991M (+60.4%) and imports USD 44,495M (+23.2%).
...
KITA monthly HS worker check on 2026-06-24:
